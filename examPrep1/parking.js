class Parking {
    ...
    getStatistics(carNumber) {
        ...
        const carIndex = this.vehicles.findIndex((car) => car.carNumber === carNumber);
        return `${this.vehicles[carIndex].carModel} == ${this.vehicles[carIndex].carNumber} - ${this.vehicles[carIndex].payed ? 'Has payed' : 'Not payed'}`
    }
}
...
console.log(parking.addCar("Volvo t6110", "TX4258CA"));
